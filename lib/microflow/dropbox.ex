defmodule Dropbox do
  ...
  def upload_file(client, local_path, remote_path, overwrite \\ true, parent_rev \\ nil) do
    ...
    Dropbox.HTTP.put client, "https://content.dropboxapi.com/1/files_put/auto/#{client.root}#{normalize_path remote_path}", {:file, local_path}, Dropbox.Metadata
  end
  ...
  def mkdir!(client, path) do
    ...
    IO.inspect URI.encode_query query
    IO.inspect "------"
